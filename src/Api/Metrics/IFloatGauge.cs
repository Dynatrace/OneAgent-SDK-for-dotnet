...
{
    /// <summary>
    /// Object created by <see cref="IOneAgentSdk.CreateFloatGaugeMetric"/>
    /// </summary>
    public interface IFloatGauge : IMetric
    {
        /// <summary>
        ...
        /// <see cref="IOneAgentSdk.CreateFloatGaugeMetric(string, string, string)"/>.
        /// </param>
        void SetValue(double currentValue, string dimensionValue = null);
    }
}
