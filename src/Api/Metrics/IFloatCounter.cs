...
{
    /// <summary>
    /// Object created by <see cref="IOneAgentSdk.CreateFloatCounterMetric"/>
    /// </summary>
    public interface IFloatCounter : IMetric
    {
        /// <summary>
        ...
        /// <see cref="IOneAgentSdk.CreateFloatCounterMetric(string, string, string)"/>.
        /// </param>
        void IncreaseBy(double by, string dimensionValue = null);
    }
}
