...
namespace Dynatrace.OneAgent.Sdk.Test
{
    ...
    /// </summary>
    public class DummyIncomingMessageReceiveTracerTests : DummyTracerTestBase<IIncomingMessageReceiveTracer>
    {
        ...
        protected override IIncomingMessageReceiveTracer CreateTracer() => OneAgentSdk.TraceIncomingMessageReceive(messagingSystemInfo);
